...
declare module 'module:web/headers.js' {
  global {
    /**
...
declare module 'module:web/url.js' {
  declare global {
    /**
    ...
    export declare class URLSearchParams {
       ...
       * @param {string | Record<string, string> | Array<[string, string]>} [init] - Initial search parameters as a string or an object.
       */
      constructor(
      ...
      /**
       * Returns number of key/value pairs in the search parameters object.
       */
      get size(): number;
