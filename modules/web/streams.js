// Bundled version of web-streams-polyfill
...
function W(e2) {
  ...
  t2._state === 'readable'
    ...
    t2._readableStreamController[P](),
    (t2._reader = undefined),
    (e2._ownerReadableStream = undefined);
}
function O(e2) {
...
function j(e2, t2) {
  e2._closedPromise_reject !== undefined &&
    (p(e2._closedPromise),
    e2._closedPromise_reject(t2),
    (e2._closedPromise_resolve = undefined),
    (e2._closedPromise_reject = undefined));
}
function A(e2) {
  e2._closedPromise_resolve !== undefined &&
...
function F(e2, t2) {
  if (typeof e2 != 'function') throw new TypeError(`${t2} is not a function.`);
}
function I(e2, t2) {
  if (
    !(function (e3) {
...
function M(e2, t2, r) {
  if (e2 === undefined) throw new TypeError(`${t2} is required in '${r}'.`);
}
function Y(e2) {
  return Number(e2);
}
...
function Q(e2, t2) {
  ...
  if (
    ...
    throw new TypeError(
      `${t2} is outside the accepted range of 0 to ${r}, inclusive`,
    );
...
function J(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_readRequests') &&
    e2 instanceof ReadableStreamDefaultReader
  );
}
function K(e2, t2) {
  ...
  (r._disturbed = true),
    r._state === 'closed'
      ? t2._closeSteps()
      : r._state === 'errored'
        ? t2._errorSteps(r._storedError)
        : r._readableStreamController[C](t2);
}
function Z(e2, t2) {
  const r = e2._readRequests;
  (e2._readRequests = new v()),
    r.forEach((e3) => {
      e3._errorSteps(t2);
    });
}
function ee(e2) {
  return new TypeError(
    `ReadableStreamDefaultReader.prototype.${e2} can only be used on a ReadableStreamDefaultReader`,
  );
}
function ne(e2) {
  return e2.slice();
...
function se(e2, t2, r) {
  if (e2.slice) return e2.slice(t2, r);
  const o2 = r - t2,
    n = new ArrayBuffer(o2);
...
function fe(e2, r = 'sync', o2) {
          ...
          const r2 = {
            ...
            return(r3) {
              ...
              try {
                ...
                if (t2 === undefined) return c({ done: true, value: r3 });
  ...
  if (o2 === undefined) throw new TypeError('The object is not iterable');
  const n = S(o2, e2, []);
...
function pe(e2) {
  return new TypeError(
    `ReadableStreamAsyncIterator.${e2} can only be used on a ReadableSteamAsyncIterator`,
  );
}
function Se(e2) {
...
function ge(e2) {
  ...
  return (
    (e2._queueTotalSize -= t2.size),
    e2._queueTotalSize < 0 && (e2._queueTotalSize = 0),
    t2.value
  );
}
function ve(e2, t2, r) {
...
function Te(e2) {
  return (
    ...
    e2 instanceof ReadableByteStreamController
  );
}
function Ce(e2) {
  return (
...
function Pe(e2) {
  ...
  b(
    ...
    () => (
      (e2._pulling = false),
      e2._pullAgain && ((e2._pullAgain = false), Pe(e2)),
      null
    ),
    (t3) => (Qe(e2, t3), null),
  );
...
function Ee(e2, t2) {
  ...
  const o2 = We(t2);
  t2.readerType === 'default'
    ? U(e2, o2, r)
    : (function (e3, t3, r2) {
        const o3 = e3._reader,
          n = o3._readIntoRequests.shift();
...
function Oe(e2, t2, r, o2) {
  e2._queue.push({ buffer: t2, byteOffset: r, byteLength: o2 }),
...
function ke(e2, t2) {
  t2.bytesFilled > 0 && Be(e2, t2.buffer, t2.byteOffset, t2.bytesFilled),
    $e(e2);
}
function je(e2, t2) {
  const r = Math.min(e2._queueTotalSize, t2.byteLength - t2.bytesFilled),
    o2 = t2.bytesFilled + r;
  let n = r,
    a = false;
  ...
  for (; n > 0; ) {
    const r2 = l.peek(),
      o3 = Math.min(n, r2.byteLength),
      a2 = t2.byteOffset + t2.bytesFilled;
    ae(t2.buffer, a2, r2.buffer, r2.byteOffset, o3),
      r2.byteLength === o3
        ? l.shift()
        : ((r2.byteOffset += o3), (r2.byteLength -= o3)),
      (e2._queueTotalSize -= o3),
      Ae(e2, o3, t2),
      (n -= o3);
  }
  return a;
...
function ze(e2) {
  e2._queueTotalSize === 0 && e2._closeRequested
    ? (Me(e2), Br(e2._controlledReadableByteStream))
    : Pe(e2);
}
function De(e2) {
  e2._byobRequest !== null &&
    ((e2._byobRequest._associatedReadableByteStreamController = undefined),
    (e2._byobRequest._view = null),
    (e2._byobRequest = null));
}
function Le(e2) {
...
function Fe(e2, t2, r, o2) {
  const n = e2._controlledReadableByteStream,
    a = t2.constructor,
    i = (function (e3) {
      return Re(e3) ? 1 : e3.BYTES_PER_ELEMENT;
    })(a),
    { byteOffset: l, byteLength: s } = t2,
    u2 = r * i;
  let c2;
  try {
    c2 = ie(t2.buffer);
...
function Ie(e2, t2) {
  ...
  De(e2);
  e2._controlledReadableByteStream._state === 'closed'
    ? (function (e3, t3) {
        t3.readerType === 'none' && $e(e3);
        const r2 = e3._controlledReadableByteStream;
        if (ot(r2)) for (; rt(r2) > 0; ) Ee(r2, $e(e3));
      })(e2, r)
    : (function (e3, t3, r2) {
        ...
        (r2.bytesFilled -= o2),
          Ee(e3._controlledReadableByteStream, r2),
          Le(e3);
      })(e2, t2, r),
    Pe(e2);
}
...
function Ye(e2) {
  ...
  if (!e2._closeRequested && t2._state === 'readable')
    if (e2._queueTotalSize > 0) e2._closeRequested = true;
    else {
      if (e2._pendingPullIntos.length > 0) {
        const t3 = e2._pendingPullIntos.peek();
        if (t3.bytesFilled % t3.elementSize != 0) {
          const t4 = new TypeError(
            'Insufficient bytes to fill elements in the given buffer',
          );
          throw (Qe(e2, t4), t4);
        }
...
function xe(e2, t2) {
  ...
  if (e2._closeRequested || r._state !== 'readable') return;
    ...
    if (
      ((function (e3) {
        ...
        for (; t3._readRequests.length > 0; ) {
          if (e3._queueTotalSize === 0) return;
  ...
  else ot(r) ? (Oe(e2, i, n, a), Le(e2)) : Oe(e2, i, n, a);
  Pe(e2);
}
function Qe(e2, t2) {
  const r = e2._controlledReadableByteStream;
...
function Ve(e2) {
  ...
  return t2 === 'errored'
    ...
    : t2 === 'closed'
      ? 0
      : e2._strategyHWM - e2._queueTotalSize;
}
function Ue(e2, t2) {
  const r = e2._pendingPullIntos.peek();
...
function Xe(e2, t2, r, o2, n, a, i) {
  (t2._controlledReadableByteStream = e2),
    (t2._pullAgain = false),
    (t2._pulling = false),
    (t2._byobRequest = null),
    (t2._queue = t2._queueTotalSize = undefined),
    we(t2),
    (t2._closeRequested = false),
    (t2._started = false),
    (t2._strategyHWM = a),
    (t2._pullAlgorithm = o2),
    (t2._cancelAlgorithm = n),
    (t2._autoAllocateChunkSize = i),
    (t2._pendingPullIntos = new v()),
    (e2._readableStreamController = t2);
  b(
    c(r()),
    () => ((t2._started = true), Pe(t2), null),
    (e3) => (Qe(t2, e3), null),
  );
}
function Je(e2) {
  return new TypeError(
    `ReadableStreamBYOBRequest.prototype.${e2} can only be used on a ReadableStreamBYOBRequest`,
  );
}
function Ke(e2) {
  return new TypeError(
    `ReadableByteStreamController.prototype.${e2} can only be used on a ReadableByteStreamController`,
  );
}
function Ze(e2, t2) {
  if ((e2 = `${e2}`) !== 'byob')
    throw new TypeError(
      `${t2} '${e2}' is not a valid enumeration value for ReadableStreamReaderMode`,
    );
  return e2;
}
function et(e2) {
...
function nt(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_readIntoRequests') &&
    e2 instanceof ReadableStreamBYOBReader
  );
}
function at(e2, t2, r, o2) {
  ...
  (n._disturbed = true),
    n._state === 'errored'
      ? o2._errorSteps(n._storedError)
      : Fe(n._readableStreamController, t2, r, o2);
}
function it(e2, t2) {
  const r = e2._readIntoRequests;
  (e2._readIntoRequests = new v()),
    r.forEach((e3) => {
      e3._errorSteps(t2);
    });
}
function lt(e2) {
  return new TypeError(
    `ReadableStreamBYOBReader.prototype.${e2} can only be used on a ReadableStreamBYOBReader`,
  );
}
function st(e2, t2) {
  const { highWaterMark: r } = e2;
  if (r === undefined) return t2;
  if (ye(r) || r < 0) throw new RangeError('Invalid highWaterMark');
  return r;
}
function ut(e2) {
  const { size: t2 } = e2;
...
function ct(e2, t2) {
  ...
  const r = e2 == null ? undefined : e2.highWaterMark,
    o2 = e2 == null ? undefined : e2.size;
  return {
    highWaterMark: r === undefined ? undefined : Y(r),
    size: o2 === undefined ? undefined : dt(o2, `${t2} has member 'size' that`),
  };
}
function dt(e2, t2) {
...
function St(e2) {
  (e2._state = 'writable'),
    (e2._storedError = undefined),
    (e2._writer = undefined),
    (e2._writableStreamController = undefined),
    (e2._writeRequests = new v()),
    (e2._inFlightWriteRequest = undefined),
    (e2._closeRequest = undefined),
    (e2._inFlightCloseRequest = undefined),
    (e2._pendingAbortRequest = undefined),
    (e2._backpressure = false);
}
function gt(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_writableStreamController') &&
    e2 instanceof WritableStream
  );
}
function vt(e2) {
...
function wt(e2, t2) {
  var r;
  if (e2._state === 'closed' || e2._state === 'errored') return c(undefined);
  (e2._writableStreamController._abortReason = t2),
    (r = e2._writableStreamController._abortController) === null ||
      r === undefined ||
      r.abort(t2);
  const o2 = e2._state;
  if (o2 === 'closed' || o2 === 'errored') return c(undefined);
...
function Rt(e2) {
  ...
  if (t2 === 'closed' || t2 === 'errored')
    return d(
      new TypeError(
        `The stream (in ${t2} state) is not in the writable state and cannot be closed`,
      ),
    );
  const r = u((t3, r2) => {
  ...
  var n;
  return (
    o2 !== undefined && e2._backpressure && t2 === 'writable' && or(o2),
    ve((n = e2._writableStreamController), Dt, 0),
    Mt(n),
    r
  );
}
...
function Ct(e2, t2) {
  ...
  const o2 = e2._writer;
  o2 !== undefined && jt(o2, t2),
    !(function (e3) {
      if (
        e3._inFlightWriteRequest === undefined &&
        e3._inFlightCloseRequest === undefined
      )
        return false;
      return true;
    })(e2) &&
...
function Pt(e2) {
  ...
  b(
    e2._writableStreamController[w](r._reason),
    () => (r._resolve(), Et(e2), null),
    (t3) => (r._reject(t3), Et(e2), null),
  );
}
function qt(e2) {
  return (
    e2._closeRequest !== undefined || e2._inFlightCloseRequest !== undefined
  );
}
function Et(e2) {
  e2._closeRequest !== undefined &&
    (e2._closeRequest._reject(e2._storedError), (e2._closeRequest = undefined));
  const t2 = e2._writer;
...
function Ot(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_ownerWritableStream') &&
    e2 instanceof WritableStreamDefaultWriter
  );
}
function Bt(e2) {
...
function kt(e2, t2) {
  e2._closedPromiseState === 'pending'
    ? Jt(e2, t2)
    : (function (e3, t3) {
        Xt(e3, t3);
      })(e2, t2);
...
function At(e2) {
  ...
  jt(e2, r),
    kt(e2, r),
    (t2._writer = undefined),
    (e2._ownerWritableStream = undefined);
}
function zt(e2, t2) {
  const r = e2._ownerWritableStream,
    o2 = r._writableStreamController,
    n = (function (e3, t3) {
      try {
  ...
  if (r !== e2._ownerWritableStream) return d(Ut('write to'));
  const a = r._state;
  if (a === 'errored') return d(r._storedError);
  if (qt(r) || a === 'closed')
    return d(
      new TypeError('The stream is closing or closed and cannot be written to'),
    );
  if (a === 'erroring') return d(r._storedError);
  const i = (function (e3) {
    return u((t3, r2) => {
      const o3 = { _resolve: t3, _reject: r2 };
...
function Lt(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_controlledWritableStream') &&
    e2 instanceof WritableStreamDefaultController
  );
}
function Ft(e2, t2, r, o2, n, a, i, l) {
  (t2._controlledWritableStream = e2),
    (e2._writableStreamController = t2),
    (t2._queue = undefined),
    (t2._queueTotalSize = undefined),
    we(t2),
    (t2._abortReason = undefined),
    (t2._abortController = (function () {
      if (pt) return new AbortController();
    })()),
    (t2._started = false),
    (t2._strategySizeAlgorithm = l),
    (t2._strategyHWM = i),
    (t2._writeAlgorithm = o2),
    (t2._closeAlgorithm = n),
    (t2._abortAlgorithm = a);
  const s = xt(t2);
  Wt(e2, s);
  b(
    c(r()),
    () => ((t2._started = true), Mt(t2), null),
    (r2) => ((t2._started = true), Tt(e2, r2), null),
  );
}
function It(e2) {
  (e2._writeAlgorithm = undefined),
    (e2._closeAlgorithm = undefined),
    (e2._abortAlgorithm = undefined),
    (e2._strategySizeAlgorithm = undefined);
}
function $t(e2) {
...
function Mt(e2) {
  ...
  if (t2._inFlightWriteRequest !== undefined) return;
  if (t2._state === 'erroring') return void Pt(t2);
  ...
  r === Dt
    ? (function (e3) {
        ...
        (function (e4) {
          (e4._inFlightCloseRequest = e4._closeRequest),
            (e4._closeRequest = undefined);
        })(t3),
          ge(e3);
        ...
        It(e3),
          b(
            ...
            () => (
              (function (e4) {
                e4._inFlightCloseRequest._resolve(undefined),
                  (e4._inFlightCloseRequest = undefined),
                  e4._state === 'erroring' &&
                    ((e4._storedError = undefined),
                    e4._pendingAbortRequest !== undefined &&
                      (e4._pendingAbortRequest._resolve(),
                      (e4._pendingAbortRequest = undefined))),
                  (e4._state = 'closed');
                const t4 = e4._writer;
                t4 !== undefined && Kt(t4);
            ...
            (e4) => (
              (function (e5, t4) {
                e5._inFlightCloseRequest._reject(t4),
                  (e5._inFlightCloseRequest = undefined),
                  e5._pendingAbortRequest !== undefined &&
                    (e5._pendingAbortRequest._reject(t4),
                    (e5._pendingAbortRequest = undefined)),
                  Tt(e5, t4);
              })(t3, e4),
              null
    ...
    : (function (e3, t3) {
        ...
        b(
          ...
          () => {
            (function (e4) {
              e4._inFlightWriteRequest._resolve(undefined),
                (e4._inFlightWriteRequest = undefined);
            })(r2);
            const t4 = r2._state;
          ...
          (t4) => (
            r2._state === 'writable' && It(e3),
            (function (e4, t5) {
              e4._inFlightWriteRequest._reject(t5),
                (e4._inFlightWriteRequest = undefined),
                Tt(e4, t5);
            })(r2, t4),
            null
...
function Nt(e2) {
  return new TypeError(
    `WritableStream.prototype.${e2} can only be used on a WritableStream`,
  );
}
function Ht(e2) {
  return new TypeError(
    `WritableStreamDefaultController.prototype.${e2} can only be used on a WritableStreamDefaultController`,
  );
}
function Vt(e2) {
  return new TypeError(
    `WritableStreamDefaultWriter.prototype.${e2} can only be used on a WritableStreamDefaultWriter`,
  );
}
function Ut(e2) {
...
function Gt(e2) {
  e2._closedPromise = u((t2, r) => {
    (e2._closedPromise_resolve = t2),
      (e2._closedPromise_reject = r),
      (e2._closedPromiseState = 'pending');
  });
}
function Xt(e2, t2) {
...
function Jt(e2, t2) {
  e2._closedPromise_reject !== undefined &&
    ...
    (e2._closedPromise_resolve = undefined),
    (e2._closedPromise_reject = undefined),
    (e2._closedPromiseState = 'rejected'));
}
function Kt(e2) {
  e2._closedPromise_resolve !== undefined &&
    (e2._closedPromise_resolve(undefined),
    (e2._closedPromise_resolve = undefined),
    (e2._closedPromise_reject = undefined),
    (e2._closedPromiseState = 'resolved'));
}
function Zt(e2) {
...
function rr(e2, t2) {
  e2._readyPromise_reject !== undefined &&
    (p(e2._readyPromise),
    e2._readyPromise_reject(t2),
    (e2._readyPromise_resolve = undefined),
    (e2._readyPromise_reject = undefined),
    (e2._readyPromiseState = 'rejected'));
}
function or(e2) {
  e2._readyPromise_resolve !== undefined &&
    (e2._readyPromise_resolve(undefined),
    (e2._readyPromise_resolve = undefined),
    (e2._readyPromise_reject = undefined),
    (e2._readyPromiseState = 'fulfilled'));
}
  ...
  return u((S2, g2) => {
      ...
      if (
        ((v = () => {
          const e2 =
              i.reason !== undefined
                ? i.reason
                : new ar('Aborted', 'AbortError'),
            o3 = [];
          n ||
            o3.push(() => (r._state === 'writable' ? wt(r, e2) : c(undefined))),
            a ||
              o3.push(() =>
                t2._state === 'readable' ? Or(t2, e2) : c(undefined),
              ),
            q2(() => Promise.all(o3.map((e3) => e3())), true, e2);
        }),
        i.aborted)
      )
        return void v();
    ...
    if (
      (P(
        t2,
        l._closedPromise,
        (e2) => (n ? E2(true, e2) : q2(() => wt(r, e2), true, e2), null),
      ),
      P(
        r,
        s._closedPromise,
        (e2) => (a ? E2(true, e2) : q2(() => Or(t2, e2), true, e2), null),
      ),
      (w = t2),
      (R = l._closedPromise),
      (T = () => (
      ...
      w._state === 'closed' ? T() : h(R, T),
      qt(r) || r._state === 'closed')
    ) {
    ...
    function O2(e2, t3) {
      return (
        At(s),
        W(l),
        i !== undefined && i.removeEventListener('abort', v),
        e2 ? g2(t3) : S2(undefined),
        null
      );
    }
    p(
...
function lr(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_controlledReadableStream') &&
    e2 instanceof ReadableStreamDefaultController
  );
}
function sr(e2) {
  if (!ur(e2)) return;
  ...
  b(
    ...
    () => (
      (e2._pulling = false),
      e2._pullAgain && ((e2._pullAgain = false), sr(e2)),
      null
    ),
    (t2) => (br(e2, t2), null),
  );
...
function cr(e2) {
  (e2._pullAlgorithm = undefined),
    (e2._cancelAlgorithm = undefined),
    (e2._strategySizeAlgorithm = undefined);
}
function dr(e2) {
  if (!mr(e2)) return;
...
function _r(e2, t2, r, o2, n, a, i) {
  (t2._controlledReadableStream = e2),
    (t2._queue = undefined),
    (t2._queueTotalSize = undefined),
    we(t2),
    (t2._started = false),
  ...
  b(
    c(r()),
    () => ((t2._started = true), sr(t2), null),
    (e3) => (br(t2, e3), null),
  );
}
function pr(e2) {
  return new TypeError(
    `ReadableStreamDefaultController.prototype.${e2} can only be used on a ReadableStreamDefaultController`,
  );
}
function yr(e2, t2) {
  return Te(e2._readableStreamController)
    ? (function (e3) {
        let t3,
          r,
          o2,
        ...
        function _2(e4) {
          m(
            ...
            (t4) => (
              e4 !== i ||
                (Qe(o2._readableStreamController, t4),
                Qe(n._readableStreamController, t4),
                (f2 && b2) || a(undefined)),
              null
            ),
          );
        ...
        function p2() {
          ...
          K(i, {
              ...
              y(() => {
                ...
                if (!f2 && !b2)
                  try {
                    ...
                    return (
                      Qe(o2._readableStreamController, t5),
                      Qe(n._readableStreamController, t5),
                      void a(Or(e3, t5))
                    );
                  }
                f2 || xe(o2._readableStreamController, r2),
                  b2 || xe(n._readableStreamController, i2),
                  (l = false),
                  s ? g2() : d2 && v();
              });
            },
            _closeSteps: () => {
              (l = false),
                f2 || Ye(o2._readableStreamController),
                b2 || Ye(n._readableStreamController),
                o2._readableStreamController._pendingPullIntos.length > 0 &&
                  Ue(o2._readableStreamController, 0),
                n._readableStreamController._pendingPullIntos.length > 0 &&
                  Ue(n._readableStreamController, 0),
                (f2 && b2) || a(undefined);
            },
            _errorSteps: () => {
              l = false;
          ...
          at(i, t4, 1, {
            _chunkSteps: (t5) => {
              y(() => {
                (s = false), (d2 = false);
                const o3 = r2 ? b2 : f2;
                if (r2 ? f2 : b2) o3 || Ge(u2._readableStreamController, t5);
                else {
                  let r3;
                  try {
                    r3 = Se(t5);
                    ...
                    return (
                      Qe(u2._readableStreamController, t6),
                      Qe(c2._readableStreamController, t6),
                      void a(Or(e3, t6))
                    );
                  }
                  o3 || Ge(u2._readableStreamController, t5),
                    xe(c2._readableStreamController, r3);
                }
                (l = false), s ? g2() : d2 && v();
              });
            },
            _closeSteps: (e4) => {
              ...
              const t5 = r2 ? b2 : f2,
                o3 = r2 ? f2 : b2;
              t5 || Ye(u2._readableStreamController),
                o3 || Ye(c2._readableStreamController),
                e4 !== undefined &&
                  (t5 || Ge(u2._readableStreamController, e4),
                  !o3 &&
                    c2._readableStreamController._pendingPullIntos.length > 0 &&
                    Ue(c2._readableStreamController, 0)),
                (t5 && o3) || a(undefined);
            },
            _errorSteps: () => {
              l = false;
    ...
    : (function (e3, t3) {
        ...
        function _2() {
          if (s) return (d2 = true), c(undefined);
          s = true;
          return (
            K(r, {
              _chunkSteps: (e4) => {
                y(() => {
                  ...
                  const t4 = e4,
                    r2 = e4;
                  f2 || fr(a._readableStreamController, t4),
                    b2 || fr(i._readableStreamController, r2),
                    (s = false),
                    d2 && _2();
                });
              },
              _closeSteps: () => {
                (s = false),
                  f2 || dr(a._readableStreamController),
                  b2 || dr(i._readableStreamController),
                  (f2 && b2) || l(undefined);
              },
              _errorSteps: () => {
                s = false;
        ...
        return (
          ...
          m(
            r._closedPromise,
            (e4) => (
              br(a._readableStreamController, e4),
              br(i._readableStreamController, e4),
              (f2 && b2) || l(undefined),
              null
            ),
          ),
...
function Sr(r) {
  return t((o2 = r)) && o2.getReader !== undefined
    ? (function (r2) {
        let o3;
        function n() {
          let e2;
    ...
    : (function (r2) {
        ...
        function i(e2) {
          ...
          if (o4 === undefined) return c(undefined);
...
function Rr(e2, t2) {
  if ((e2 = `${e2}`) !== 'bytes')
    throw new TypeError(
      `${t2} '${e2}' is not a valid enumeration value for ReadableStreamType`,
    );
  return e2;
}
function Tr(e2, t2) {
  L(e2, t2);
  const r = e2 == null ? undefined : e2.preventAbort,
    o2 = e2 == null ? undefined : e2.preventCancel,
    n = e2 == null ? undefined : e2.preventClose,
    a = e2 == null ? undefined : e2.signal;
  return (
    a !== undefined &&
      (function (e3, t3) {
        if (
...
function Er(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_readableStreamController') &&
    e2 instanceof ReadableStream
  );
}
function Wr(e2) {
...
function Or(t2, r) {
  if (((t2._disturbed = true), t2._state === 'closed')) return c(undefined);
  if (t2._state === 'errored') return d(t2._storedError);
  Br(t2);
  const o2 = t2._reader;
...
function jr(e2) {
  return new TypeError(
    `ReadableStream.prototype.${e2} can only be used on a ReadableStream`,
  );
}
function Ar(e2, t2) {
  L(e2, t2);
...
function Dr(e2) {
  return new TypeError(
    `ByteLengthQueuingStrategy.prototype.${e2} can only be used on a ByteLengthQueuingStrategy`,
  );
}
function Lr(e2) {
  return (
    ...
    e2 instanceof ByteLengthQueuingStrategy
  );
}
function Ir(e2) {
  return new TypeError(
    `CountQueuingStrategy.prototype.${e2} can only be used on a CountQueuingStrategy`,
  );
}
function $r(e2) {
  return (
    ...
    e2 instanceof CountQueuingStrategy
  );
}
function Mr(e2, t2, r) {
  return F(e2, r), (r2) => g(e2, t2, [r2]);
...
function Nr(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_transformStreamController') &&
    e2 instanceof TransformStream
  );
}
function Hr(e2, t2) {
...
function Vr(e2, t2) {
  Jr(e2._transformStreamController),
    Yt(e2._writable._writableStreamController, t2),
    Ur(e2);
}
function Ur(e2) {
...
function Gr(e2, t2) {
  e2._backpressureChangePromise !== undefined &&
    e2._backpressureChangePromise_resolve(),
    (e2._backpressureChangePromise = u((t3) => {
...
function Xr(e2) {
  return (
    !!t(e2) &&
    !!Object.prototype.hasOwnProperty.call(e2, '_controlledTransformStream') &&
    e2 instanceof TransformStreamDefaultController
  );
}
function Jr(e2) {
  (e2._transformAlgorithm = undefined),
    (e2._flushAlgorithm = undefined),
    (e2._cancelAlgorithm = undefined);
}
function Kr(e2, t2) {
  const r = e2._controlledTransformStream,
    o2 = r._readable._readableStreamController;
  if (!mr(o2))
...
function eo(e2) {
  return new TypeError(
    `TransformStreamDefaultController.prototype.${e2} can only be used on a TransformStreamDefaultController`,
  );
}
function to(e2) {
  e2._finishPromise_resolve !== undefined &&
    (e2._finishPromise_resolve(),
    (e2._finishPromise_resolve = undefined),
    (e2._finishPromise_reject = undefined));
}
function ro(e2, t2) {
  e2._finishPromise_reject !== undefined &&
    (p(e2._finishPromise),
    e2._finishPromise_reject(t2),
    (e2._finishPromise_resolve = undefined),
    (e2._finishPromise_reject = undefined));
}
function oo(e2) {
  return new TypeError(
    `TransformStream.prototype.${e2} can only be used on a TransformStream`,
  );
}
var r = e;
var n = Promise;
...
class v {
  ...
  push(e2) {
    const t2 = this._back;
    let r2 = t2;
    t2._elements.length === 16383 && (r2 = { _elements: [], _next: undefined }),
      t2._elements.push(e2),
      r2 !== t2 && ((this._back = r2), (t2._next = r2)),
      ++this._size;
  }
  shift() {
    ...
    let o2 = r2 + 1;
    const n2 = e2._elements,
      a2 = n2[r2];
    return (
      o2 === 16384 && ((t2 = e2._next), (o2 = 0)),
      --this._size,
      (this._cursor = o2),
      e2 !== t2 && (this._front = t2),
      (n2[r2] = undefined),
      a2
    );
  }
  forEach(e2) {
    ...
    for (
      ;
      !(
        (t2 === o2.length && r2._next === undefined) ||
        (t2 === o2.length &&
          ((r2 = r2._next), (o2 = r2._elements), (t2 = 0), o2.length === 0))
      );
    )
      e2(o2[t2]), ++t2;
  }
...
class ReadableStreamDefaultReader {
  constructor(e2) {
    if (
      ($(e2, 1, 'ReadableStreamDefaultReader'),
  ...
  read() {
    ...
    if (this._ownerReadableStream === undefined) return d(O('read from'));
    let e2, t2;
    const r2 = u((r3, o2) => {
      (e2 = r3), (t2 = o2);
    });
    return (
      K(this, {
        _chunkSteps: (t3) => e2({ value: t3, done: false }),
        _closeSteps: () => e2({ value: undefined, done: true }),
...
var ie = (e2) => (
  (ie =
    typeof e2.transfer == 'function'
      ? (e3) => e3.transfer()
      : typeof structuredClone == 'function'
        ? (e3) => structuredClone(e3, { transfer: [e3] })
        : (e3) => e3),
  ie(e2)
);
var le = (e2) => (
  (le =
    typeof e2.detached == 'boolean'
      ? (e3) => e3.detached
      : (e3) => e3.byteLength === 0),
  le(e2)
);
var de =
  (oe =
    (te = Symbol.asyncIterator) !== null && te !== undefined
      ? te
      : (re = Symbol.for) === null || re === undefined
        ? undefined
        : re.call(Symbol, 'Symbol.asyncIterator')) !== null && oe !== undefined
    ? oe
    : '@@asyncIterator';
...
class he {
  constructor(e2, t2) {
    (this._ongoingPromise = undefined),
      ...
      (this._reader = e2),
      (this._preventCancel = t2);
  }
  next() {
    const e2 = () => this._nextSteps();
    return (
      (this._ongoingPromise = this._ongoingPromise
        ? _(this._ongoingPromise, e2, e2)
        : e2()),
  ...
  _nextSteps() {
    ...
    return (
      K(e2, {
        _chunkSteps: (e3) => {
          (this._ongoingPromise = undefined),
            y(() => t2({ value: e3, done: false }));
        },
        _closeSteps: () => {
          (this._ongoingPromise = undefined),
            (this._isFinished = true),
            W(e2),
            t2({ value: undefined, done: true });
        },
        _errorSteps: (t3) => {
          (this._ongoingPromise = undefined),
            (this._isFinished = true),
...
class ReadableByteStreamController {
  ...
  close() {
    ...
    if (e2 !== 'readable')
      throw new TypeError(
        `The stream (in ${e2} state) is not in the readable state and cannot be closed`,
      );
    Ye(this);
  }
  enqueue(e2) {
    ...
    if (t2 !== 'readable')
      throw new TypeError(
        `The stream (in ${t2} state) is not in the readable state and cannot be enqueued to`,
      );
    xe(this, e2);
  }
  error(e2 = undefined) {
  ...
  [C](e2) {
    ...
    if (this._queueTotalSize > 0) return void Ne(this, e2);
  ...
  [P]() {
    if (this._pendingPullIntos.length > 0) {
      ...
      (e2.readerType = 'none'),
        ...
        this._pendingPullIntos.push(e2);
    }
  }
}
...
class ReadableStreamBYOBReader {
  constructor(e2) {
    if (
      ($(e2, 1, 'ReadableStreamBYOBReader'), N(e2, 'First parameter'), Wr(e2))
    )
      throw new TypeError(
        'This stream has already been locked for exclusive reading by another reader',
      );
  ...
  read(e2, t2 = {}) {
    ...
    try {
      r2 = (function (e3, t3) {
        ...
        return (
          ...
          {
            min: Q(
              (r3 = e3 == null ? undefined : e3.min) !== null &&
                r3 !== undefined
                ? r3
                : 1,
              `${t3} has member 'min' that`,
            ),
          }
        );
      })(t2, 'options');
    ...
    const o2 = r2.min;
    if (o2 === 0) return d(new TypeError('options.min must be greater than 0'));
    if (
      (function (e3) {
    ...
    return (
      at(this, e2, o2, {
        _chunkSteps: (e3) => n2({ value: e3, done: false }),
        _closeSteps: (e3) => n2({ value: e3, done: true }),
        _errorSteps: (e3) => a2(e3),
      }),
      i2
    );
  }
...
class WritableStream {
  constructor(e2 = {}, t2 = {}) {
    ...
    const r2 = ct(t2, 'Second parameter'),
      o2 = (function (e3, t3) {
        L(e3, t3);
        const r3 = e3 == null ? undefined : e3.abort,
          o3 = e3 == null ? undefined : e3.close,
          n3 = e3 == null ? undefined : e3.start,
          a2 = e3 == null ? undefined : e3.type,
          i2 = e3 == null ? undefined : e3.write;
        return {
          abort:
            r3 === undefined
              ? undefined
              : ft(r3, e3, `${t3} has member 'abort' that`),
          close:
            o3 === undefined
              ? undefined
              : bt(o3, e3, `${t3} has member 'close' that`),
          start:
            n3 === undefined
              ? undefined
              : ht(n3, e3, `${t3} has member 'start' that`),
          write:
            i2 === undefined
              ? undefined
              : mt(i2, e3, `${t3} has member 'write' that`),
          type: a2,
        };
      })(e2, 'First parameter');
    St(this);
    ...
    (function (e3, t3, r3, o3) {
      ...
      i2 =
        t3.write !== undefined ? (e4) => t3.write(e4, n3) : () => c(undefined);
  ...
  abort(e2 = undefined) {
    return gt(this)
      ? vt(this)
        ? d(new TypeError('Cannot abort a stream that already has a writer'))
        : wt(this, e2)
      : d(Nt('abort'));
  }
  close() {
...
class WritableStreamDefaultWriter {
  constructor(e2) {
    if (
      ($(e2, 1, 'WritableStreamDefaultWriter'),
      _t(e2, 'First parameter'),
      vt(e2))
    )
      throw new TypeError(
    ...
    else if (t2 === 'erroring') er(this, e2._storedError), Gt(this);
    else if (t2 === 'closed') tr(this), Gt((r2 = this)), Kt(r2);
    else {
  ...
  get desiredSize() {
    ...
    if (this._ownerWritableStream === undefined) throw Ut('desiredSize');
    return (function (e2) {
      const t2 = e2._ownerWritableStream,
        r2 = t2._state;
      if (r2 === 'errored' || r2 === 'erroring') return null;
      if (r2 === 'closed') return 0;
...
var ar =
  (function () {
    ...
    return (function (e3) {
      if (typeof e3 != 'function' && typeof e3 != 'object') return false;
      if (e3.name !== 'DOMException') return false;
      try {
        return new e3(), true;
      } catch (e4) {
        return false;
  ...
  (function () {
    ...
    return (
      ...
      Object.defineProperty(e2.prototype, 'constructor', {
        value: e2,
        writable: true,
        configurable: true,
      }),
...
class ReadableStream {
  constructor(e2 = {}, t2 = {}) {
    ...
    const r2 = ct(t2, 'Second parameter'),
      o2 = (function (e3, t3) {
        L(e3, t3);
        const r3 = e3,
          o3 = r3 == null ? undefined : r3.autoAllocateChunkSize,
          n2 = r3 == null ? undefined : r3.cancel,
          a2 = r3 == null ? undefined : r3.pull,
          i2 = r3 == null ? undefined : r3.start,
          l2 = r3 == null ? undefined : r3.type;
        return {
          autoAllocateChunkSize:
            o3 === undefined
              ? undefined
              : Q(o3, `${t3} has member 'autoAllocateChunkSize' that`),
          cancel:
            n2 === undefined
              ? undefined
              : gr(n2, r3, `${t3} has member 'cancel' that`),
          pull:
            a2 === undefined
              ? undefined
              : vr(a2, r3, `${t3} has member 'pull' that`),
          start:
            i2 === undefined
              ? undefined
              : wr(i2, r3, `${t3} has member 'start' that`),
          type:
            l2 === undefined
              ? undefined
              : Rr(l2, `${t3} has member 'type' that`),
        };
      })(e2, 'First parameter');
    if ((qr(this), o2.type === 'bytes')) {
      ...
      (function (e3, t3, r3) {
        ...
        (n2 = t3.start !== undefined ? () => t3.start(o3) : () => {}),
          (a2 = t3.pull !== undefined ? () => t3.pull(o3) : () => c(undefined)),
          (i2 =
            t3.cancel !== undefined
              ? (e4) => t3.cancel(e4)
              : () => c(undefined));
      ...
      (function (e4, t3, r3, o3) {
        ...
        (a2 = t3.start !== undefined ? () => t3.start(n2) : () => {}),
          (i2 = t3.pull !== undefined ? () => t3.pull(n2) : () => c(undefined)),
          (l2 =
            t3.cancel !== undefined
              ? (e5) => t3.cancel(e5)
              : () => c(undefined)),
          _r(e4, n2, a2, i2, l2, r3, o3);
      })(this, o2, st(r2, 1), e3);
    }
  }
  get locked() {
  ...
  cancel(e2 = undefined) {
    return Er(this)
      ? Wr(this)
        ? d(new TypeError('Cannot cancel a stream that already has a reader'))
        : Or(this, e2)
      : d(jr('cancel'));
  }
  getReader(e2 = undefined) {
    ...
    return (function (e3, t2) {
      ...
      return {
        mode:
          r2 === undefined ? undefined : Ze(r2, `${t2} has member 'mode' that`),
      };
    })(e2, 'First parameter').mode === undefined
      ? H(this)
      : et(this);
  }
  pipeThrough(e2, t2 = {}) {
    ...
    const r2 = (function (e3, t3) {
        ...
        M(r3, 'readable', 'ReadableWritablePair'),
          N(r3, `${t3} has member 'readable' that`);
        const o3 = e3 == null ? undefined : e3.writable;
        return (
          M(o3, 'writable', 'ReadableWritablePair'),
          _t(o3, `${t3} has member 'writable' that`),
          { readable: r3, writable: o3 }
        );
      })(e2, 'First parameter'),
      o2 = Tr(t2, 'Second parameter');
    if (Wr(this))
      throw new TypeError(
  ...
  pipeTo(e2, t2 = {}) {
    ...
    if (e2 === undefined) return d("Parameter 1 is required in 'pipeTo'.");
    if (!gt(e2))
      return d(
        new TypeError(
...
class ByteLengthQueuingStrategy {
  constructor(e2) {
    $(e2, 1, 'ByteLengthQueuingStrategy'),
      (e2 = Ar(e2, 'First parameter')),
...
class TransformStream {
  constructor(e2 = {}, t2 = {}, r2 = {}) {
    ...
    const o2 = ct(t2, 'Second parameter'),
      n2 = ct(r2, 'Third parameter'),
      a2 = (function (e3, t3) {
        L(e3, t3);
        const r3 = e3 == null ? undefined : e3.cancel,
          o3 = e3 == null ? undefined : e3.flush,
          n3 = e3 == null ? undefined : e3.readableType,
          a3 = e3 == null ? undefined : e3.start,
          i3 = e3 == null ? undefined : e3.transform,
          l3 = e3 == null ? undefined : e3.writableType;
        return {
          cancel:
            r3 === undefined
              ? undefined
              : Qr(r3, e3, `${t3} has member 'cancel' that`),
          flush:
            o3 === undefined
              ? undefined
              : Mr(o3, e3, `${t3} has member 'flush' that`),
          readableType: n3,
          start:
            a3 === undefined
              ? undefined
              : Yr(a3, e3, `${t3} has member 'start' that`),
          transform:
            i3 === undefined
              ? undefined
              : xr(i3, e3, `${t3} has member 'transform' that`),
          writableType: l3,
        };
      })(e2, 'First parameter');
    ...
    (function (e3, t3, r3, o3, n3, a3) {
        ...
        return (function (e4, t5) {
          ...
          if (e4._backpressure) {
            return _(e4._backpressureChangePromise, () => {
              ...
              if (o4._state === 'erroring') throw o4._storedError;
              return Zr(r4, t5);
            });
          }
          return Zr(r4, t5);
      ...
      function s3(t4) {
        return (function (e4, t5) {
          const r4 = e4._transformStreamController;
          if (r4._finishPromise !== undefined) return r4._finishPromise;
          ...
          return (
            ...
            b(
              ...
              () => (
                o4._state === 'errored'
                  ? ro(r4, o4._storedError)
                  : (br(o4._readableStreamController, t5), to(r4)),
                null
              ),
              (e5) => (br(o4._readableStreamController, e5), ro(r4, e5), null),
            ),
            r4._finishPromise
          );
        })(e3, t4);
      ...
      function c2() {
        return (function (e4) {
          ...
          if (t4._finishPromise !== undefined) return t4._finishPromise;
          ...
          return (
            ...
            b(
              ...
              () => (
                r4._state === 'errored'
                  ? ro(t4, r4._storedError)
                  : (dr(r4._readableStreamController), to(t4)),
                null
              ),
              (e5) => (br(r4._readableStreamController, e5), ro(t4, e5), null),
            ),
            t4._finishPromise
          );
        })(e3);
          ...
          return (
            ...
            b(
              ...
              () => (
                o4._state === 'errored'
                  ? ro(r4, o4._storedError)
                  : (Yt(o4._writableStreamController, t5), Ur(e4), to(r4)),
                null
              ),
              (t6) => (
                Yt(o4._writableStreamController, t6), Ur(e4), ro(r4, t6), null
              ),
            ),
            r4._finishPromise
          );
      ...
      (e3._writable = (function (e4, t4, r4, o4, n4 = 1, a4 = () => 1) {
        ...
        (e3._readable = Cr(i3, d2, f3, n3, a3)),
        (e3._backpressure = undefined),
        (e3._backpressureChangePromise = undefined),
        (e3._backpressureChangePromise_resolve = undefined),
        Gr(e3, true),
        (e3._transformStreamController = undefined);
    })(
      this,
      u((e3) => {
        h2 = e3;
      ...
      (function (e3, t3) {
        ...
        let o3, n3, a3;
        o3 =
          t3.transform !== undefined
            ? (e4) => t3.transform(e4, r3)
            : (e4) => {
                try {
        ...
        a3 =
          t3.cancel !== undefined ? (e4) => t3.cancel(e4) : () => c(undefined);
        (function (e4, t4, r4, o4, n4) {
          (t4._controlledTransformStream = e4),
            (e4._transformStreamController = t4),
            (t4._transformAlgorithm = r4),
            (t4._flushAlgorithm = o4),
            (t4._cancelAlgorithm = n4),
            (t4._finishPromise = undefined),
            (t4._finishPromise_resolve = undefined),
            (t4._finishPromise_reject = undefined);
        })(e3, r3, o3, n3, a3);
      })(this, a2),
      a2.start !== undefined
        ? h2(a2.start(this._transformStreamController))
        : h2(undefined);
  }
  get readable() {
