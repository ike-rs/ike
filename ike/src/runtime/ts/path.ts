...
export const normalize: PathModule["normalize"] = function (path: string): string {
    if (path.length === 0) {
        return ".";
    }
...
export const toNamespacedPath: PathModule["toNamespacedPath"] = function (p): string {
...
export const basename: PathModule["basename"] = function (p, extension): string {
