declare module "test" {
  ...
  export type Matchers = {
    ...
    /**
     * Asserts that the object contains all of the specified keys.
     * @param {string[]} keys - The keys to check for.
     * @throws {Error} If the object does not contain all of the specified keys.
     */
    ...
    /**
     * Asserts that the object contains all of the specified values.
     * @param {any[]} expected - The values to check for.
     * @throws {Error} If the object does not contain all of the specified values.
     */
